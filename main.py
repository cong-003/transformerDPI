...
if __name__ == "__main__":
    ...
    AUCs = ('Epoch\tTime(sec)\tLoss_train\tLoss_test\tAUC_dev\tPRC_dev')
    ...
    for epoch in range(1, iteration+1):
        ...
        AUC_dev, PRC_dev, loss_test = tester.test(dataset_dev)

        end = timeit.default_timer()
        time = end - start

        AUCs = [epoch, time, loss_train, loss_test, AUC_dev,PRC_dev]
